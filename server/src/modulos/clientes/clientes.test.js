...
describe('Clientes API', () => {
  test('debería crear un nuevo cliente', async () => {
    ...
    expect(responseBody.body).toBe('Item guardado con exito'); 
  });
  ...
  test('debería actualizar un cliente existente', async () => {
    const idCliente = 71; // Asegúrate de que este ID existe en tu base de datos
    const updatedClient = {
  ...
  test('debería eliminar un cliente existente', async () => {
    const idCliente = 72; // Asegúrate de que este ID existe en tu base de datos
